# -*- coding: utf-8 -*-
"""
Created on Tue Jan 31 22:41:14 2023
1 提取1981-2020 本站气压
2 提取TC活动日 本站气压
@author: Lenovo
"""
...
#读取40年80个站点的温度
data0=pd.read_table("F:\\snow_sts_data\\1981-2020\\prs1981_2020.txt",
...
data3=data2.pivot(index='time', columns='station', values='prs')
#根据站点顺序重新排序
path_sta='F:\\snow_sts_data\\after_quality_control\\tp_sta_info_by2014.txt'
...
ds = xr.Dataset()
ds['prs'] = (('time','station'),data5*units('hPa'))
...
print('保存的数据: \n{}'.format(ds))
ds.to_netcdf('F:\\snow_sts_data\\ERA5\\all\\deal\\prs_station.nc') 
