...
#%% branch1 读取所有变量 并组合文件
# https://blog.csdn.net/LHgwei/article/details/127902909

# import os
# path1="F:\\snow_sts_data\\regress\\variable\\"
#   #文件夹路径
# file_list=[]#新建列表
...
#       data1 = xr.open_dataset(file_list[i])
#       file_new.append((data1))  
...
#     # #删除任何有nan的行
#     sta_reg3=sta_reg2.dropna(axis=0, how='any',inplace=False) #885 876
